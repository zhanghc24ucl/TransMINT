...
bts = []
#          3e-05  , 1e-05  , 8e-06*  , 3e-06
for lr in [0.00003, 0.00001, 0.000008, 0.000003]:
    bt_cfg = copy.deepcopy(base_bt_cfg)
    bt_cfg.trainer_cfg.optimizer_params['lr'] = lr

    bt = Backtest(bt_cfg, data_provider, store_path=f'vault/20250815_lr_sharpe2/l{lr}_s{seed}')
    bts.append(bt)
